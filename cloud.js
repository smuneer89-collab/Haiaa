...
const CLOUD_COLLECTIONS = {
  ...
  cultureMemberLinks: () => cultureMemberLinks,
  ...
  function applyRemote(name, arr){
    ...
    try{
      switch(name){
        ...
        case 'cultureMemberLinks': cultureMemberLinks=arr; storage.set('cultureMemberLinks',JSON.stringify(arr)); if(typeof renderCultureHub==='function') renderCultureHub(); break;
